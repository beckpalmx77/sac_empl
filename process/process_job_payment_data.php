...
$sql_find2 = "SELECT job_date , sum(percent) AS percent FROM v_job_transaction WHERE effect_month = '" . $effect_month . "' AND effect_year = '" . $effect_year . "' GROUP BY job_date ";
...
WHERE job_date = '" . $result4['job_date'] . "' AND effect_month = '" . $effect_month . "' AND effect_year = '" . $effect_year . "'";
...
$sql_find_month = "SELECT * FROM job_payment_month_total WHERE effect_month = '" . $effect_month . "' AND effect_year = '" . $effect_year . "' ORDER BY id ";
//echo "Update2 = " . $sql_find2;
...
$sql_find_trans = "SELECT * FROM job_transaction WHERE effect_month = '" . $effect_month . "' AND effect_year = '" . $effect_year . "' ORDER BY job_date,emp_id ";
...
foreach ($results_trans as $result_trans) {
    ...
    $sql_find_daily = "select * from job_payment_daily_total
WHERE job_date = '" . $result_trans['job_date'] . "' AND effect_month = '" . $effect_month . "' AND effect_year = '" . $effect_year . "'";
